...
> Source: [[source-documents/product-docs/eventual-product-vision.md]]
...
The expansion thesis is straightforward: each new domain (recruiting, real estate, investment research) brings new data sources and new signals, but the core infrastructure — ingestion pipelines, signal extraction, agent-native serving — carries over. We build GTM as a vertical instance of a general capability, not as a GTM-only tool.
